            ...
            {navItems.map((item) => (
              <li key={item.href}>
                {item.isRoute ? (
                  ...
                  <Link
                    to="/"
                    className="px-3 lg:px-4 py-2 text-sm font-mono uppercase transition-colors hover:text-primary text-muted-foreground"
                  >
                    {item.label}
                  </Link>
                )}
                ...
                <li key={item.href}>
                  {item.isRoute ? (
                    ...
                    <Link
                      to="/"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="block px-4 py-3 text-sm font-mono uppercase transition-colors hover:bg-muted rounded text-muted-foreground"
                    >
                      {item.label}
                    </Link>
                  )}
